...
const getReviewCount = () => {
    return document.querySelectorAll('.mapsLiteJsReviewsReviewspage__ml-reviews-page-user-review-container').length;
};
...
exports.reviews = async (req, res) => {
    ...
    try {
        await page.waitForSelector('#app > div.ml-pane-container > div.visible > div > div.mapsLiteJsReviewsReviewspage__ml-reviews-page-white-background > div:nth-child(2)');
    } catch (error) {
        console.log(error);
